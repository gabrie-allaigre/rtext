...
public class RtextConfigurationBuilder {
	...
	public RtextConfigurationBuilder registerTypeAdapter(Type type, IRtextTypeAdapter<?> typeAdapter) {
		rtextConfiguration.typeAdapterFactories.add(new RtextTypeAdapterFactoryAdapter(TypeAdaptersHelper
				                                                                               .newTypeFactory(TypeToken
						                                                                                               .of(String.class),
				                                                                                               TypeToken
						                                                                                               .of(type),
				                                                                                               (IRtextTypeAdapter) typeAdapter)));
		return this;
	}
	...
	private static class RtextTypeAdapterFactoryAdapter implements IRtextTypeAdapterFactory {
		...
		public RtextTypeAdapterFactoryAdapter(
				ITypeAdapterFactory<Rtext> typeAdapterFactory) {
			super();
		...
		public <T> IRtextTypeAdapter<T> create(Rtext rtext, TypeToken<T> typeToken) {
			return new RtextTypeAdapter<T>(typeAdapterFactory.create(rtext, TypeToken.of(String.class),
			                                                         typeToken));
		}
	}
